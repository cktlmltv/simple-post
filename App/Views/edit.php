<div id="sp-header-edit"class="container-fluid">
	...
	<div class="col-xs-8 col-xs-push-2 text-center">
		...
		<thead>
		    <tr>
			<td colspan="2">
			    <a onclick="displayUrls()" data-urlsdisplayed="false"><h3>Vos urls d'accées <span class="text-muted">(Cliquer pour afficher)</span></h3></a>
		...
		<tbody id="sp-url-container"style="display:none;">
		    <tr>
